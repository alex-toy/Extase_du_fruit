	...
	<body>
		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="location/listLocations">Créer un compte</a></li>
				</ul>
			</nav>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<a href="#main" class="button big scrolly">Où nous trouver</a>
					<a href="#suggestion" class="button big scrolly">Suggestion de la semaine</a>
				</div>
			</section>
		...
		<!-- Main -->
			<div id="main">
							...
							<!-- 2 Columns -->
								<div class="flex flex-2">
									...
									<div class="col col2">
										...
										<p>Lundi : Saint Jean de Bournay - place du marché.</p> 
										<p>Mardi : Monplaisir lumière - place Ambroise Courtois - angle du premier 1er film.</p>
										<p>Jeudi : Monplaisir lumière - place Ambroise Courtois - angle du premier 1er film..</p>
										<p>Vendredi : Neuville sur Saone.</p>
										<p>Samedi : Monplaisir Lumière.</p>
										<p>Dimanche : quai saint Antoine - devant la buvette.</p>
				...
				<!-- Section -->
					<section id="suggestion" class="wrapper style1">
						<div class="inner">
							<header class="align-center">
								<h2>Suggestion de la semaine</h2>
								<p>Découvrez nos meilleurs produits de la semaine.</p>
							</header>
