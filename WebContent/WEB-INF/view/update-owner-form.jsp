...
<head>
	<title>Modification d'un propriétaire</title>
...
<body>
	...
	<div id="wrapper">
		<div id="header">
			<h2>C353 P2 - Modification d'un propriétaire</h2>
		</div>
	</div>
	...
	<section class="wrapper style1">
		...
		<a href="http://localhost:8080/C353_P2_V0/owner/listOwners">Retour a la liste des propriétaires</a>		
	</section>
